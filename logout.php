      ...
      <div class="container">      
        <div class="row space-100">
          <div class="col-lg-6 col-md-12 col-xs-12">
            <div class="contents">
            <h2 class='head-title'>คุณได้ทำการออกจากระบบเรียบร้อยแล้วครับ</h2>
              <div class="header-button">
                <a href="index.html" class="btn btn-border-filled"><div class="icon">
                  <i class="lni-arrow-left-circle" style="font-size: 1.3em;"></i>
                <span>Back</span></div></a>
              </div>
            </div>
          </div>
