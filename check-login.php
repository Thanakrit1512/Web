...
<html lang="en">
  ...
  <body>
	...
	if(!$objResult)
	{
      echo "<h2 class='head-title'>เกิดข้อผิดพลาด</h2> 
      <p>'ไอดีผู้ใช้หรือรหัสไม่ถูกต้อง กรุณาตรวจสอบอีกครั้ง!!!'</p> ";
	}
	else
	{
...
?>
              <div class="header-button">
                <a href="signin.html" class="btn btn-border-filled"><div class="icon">
